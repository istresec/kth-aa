...
python2 minifier.py "src/TSP.cpp" > "tmp/TSP.cpp"
# cp "src/TSP.cpp" "tmp/TSP.cpp"
...
python submit.py -p tsp -l C++ tmp/main_kattis.cpp tmp/TSP.h tmp/TSP.cpp tmp/utility.h tmp/utility.cpp tmp/blossom.h
